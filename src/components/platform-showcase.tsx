...
const features = [
  ...
  },
  {
    ...
    description: "LightPath scans 40+ benefit programs against your specific situation \u2014 Social Security, VA benefits, employer programs, unclaimed property, state-specific programs \u2014 and surfaces what you qualify for.",
    bullets: [
      { text: "Scans eligibility across 40+ federal and state programs" },
  ...
  },
  {
    ...
    description: "88 clinical interventions drawn from 16 therapeutic frameworks \u2014 DBT, ACT, somatic experiencing, continuing bonds, narrative repair, and more. Each tool adapts to your emotional state, grief phase, and what\u2019s helped before.",
    bullets: [
      { text: "15 feeling states \u2014 the platform meets you where you are" },
      { text: "Therapeutic progression tracks across 9 clinical pathways" },
      { text: "Clinical safety layer blocks premature deep work" },
      { text: "Journal entries, breathing, grounding, and memory tools" },
    ],
  },
  {
    id: "findcare",
