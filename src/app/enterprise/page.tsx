              ...
              <div className="space-y-4">
                {[
                  ...
                  },
                  {
                    ...
                    metric: "147",
                    metricLabel: "tasks guided",
                  },
                  {
                    time: "Month 1\u20133",
                    title: "An AI companion who actually shows up",
                    detail: "16 specialized AI companions matched by loss type. Remembers their story, adapts to their emotional state, available 24/7.",
                    color: "#63D583",
